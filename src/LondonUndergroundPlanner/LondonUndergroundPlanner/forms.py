...
## line 11 commented out as trains available to use currently include DLR stations
## this can be changed by uncommenting out line 11 and commenting out lin 12
# df = pd.read_excel('LondonUndergroundPlanner\\coursework_code\\LondonUndergroundData.xlsx')
df = pd.read_excel('LondonUndergroundPlanner\\coursework_code\\TrainDataWithDLR.xlsx')
